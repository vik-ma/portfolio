  ...
  return (
    <div className="text-stone-200 text-left">
      ...
      <p className="p-0.5 md:p-1 pb-2">
        ...
        <strong className="text-stone-100">Next.js</strong> and{" "}
        <strong className="text-stone-100">TailwindCSS</strong>.
      </p>
      <h2 className="w-fit text-2xl md:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-sky-400">
        Credits
      </h2>
      <p className="p-0.5 md:p-1">ASDASD</p>
    </div>
  );
}
